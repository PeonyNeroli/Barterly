...
class EditProfilePageModel extends FlutterFlowModel<EditProfilePageWidget> {
  ...
  // Stores action output result for [Backend Call - API (ImageApi)] action in Container widget.
