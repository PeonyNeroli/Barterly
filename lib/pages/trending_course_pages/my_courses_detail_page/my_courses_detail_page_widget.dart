...
import 'my_courses_detail_page_model.dart';
export 'my_courses_detail_page_model.dart';

class MyCoursesDetailPageWidget extends StatefulWidget {
  const MyCoursesDetailPageWidget({
    super.key,
  ...
  static String routeName = 'MyCoursesDetailPage';
  static String routePath = '/myCoursesDetailPage';

  @override
  State<MyCoursesDetailPageWidget> createState() =>
      _MyCoursesDetailPageWidgetState();
}

class _MyCoursesDetailPageWidgetState extends State<MyCoursesDetailPageWidget> {
  late MyCoursesDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyCoursesDetailPageModel());
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    if (EducationAPIsGroup.lessonApiCall
                                            .success(
                                      ...
                                      return Builder(
                                        builder: (context) {
                                          ...
                                          return RefreshIndicator(
                                            key: Key(
                                                'RefreshIndicator_gj7ku92n'),
                                            color: FlutterFlowTheme.of(context)
                                                .primary,
                                            onRefresh: () async {
                                              safeSetState(() {
                                                FFAppState()
                                                    .clearMyCourseDetailCacheCacheKey(
                                                        _model
