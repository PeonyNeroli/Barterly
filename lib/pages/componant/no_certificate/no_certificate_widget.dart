...
import 'no_certificate_model.dart';
export 'no_certificate_model.dart';

class NoCertificateWidget extends StatefulWidget {
  const NoCertificateWidget({super.key});
...
class _NoCertificateWidgetState extends State<NoCertificateWidget> {
  late NoCertificateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoCertificateModel());
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'The certificate may have expired and is no \nlonger valid.',
              textAlign: TextAlign.center,
              maxLines: 2,
              style: FlutterFlowTheme.of(context).bodyMedium.override(
                    fontFamily: 'SF Pro Display',
